...
if (process.env.RESET_DATABASE) {
  ...
  const seedDatabase = async () => {
    ...
    await new Book({ title: 'Harry Potter and the Prisoner ofd Askaban', author: rowling }).save()
    await new Book({ title: 'Harry Potter and the Goblert of Fire', author: rowling }).save()
